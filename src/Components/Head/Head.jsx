					...
					<Heading>
						...
						<ActionsDiv>
							<a
								// eslint-disable-next-line
								rel="noreferrer"
								href="https://drive.google.com/file/d/1zJe6_UhBecfG8jffxfjjAxIFwRLlNBeI/view?usp=sharing"
								target="_blank"
							>
								<CTAButton currentTheme={currentTheme}>My Resume</CTAButton>
							</a>
						</ActionsDiv>
					</Heading>
					<Profile>
						<img
							src="https://avatars.githubusercontent.com/u/77038785?v=4"
							alt="profile"
						></img>
					</Profile>
				</HeaderContent>
